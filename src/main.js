...
function projectsHtml() {
  ...
  projectsArr.forEach((project) => {
    ...
    <a href=${project.hostedSite} target="_blank">Hosted Website</a>
...
function resume() {
  ...
  for (const prop in skill) {
    if (prop !== "title" && prop !== "image") {
      skillList += `<image class="checkMark" src="${skill.image}"/> ${skill[prop]}`;
    }
  }
  ...
  // newLi.innerHTML = `<h4>${skill.title}</h4>
  //  <image class="checkmark" src="../assets/checkmark.png"/>${skill.skill1}
  //  <image class="checkmark" src="../assets/checkmark.png"/>${skill.skill2}
  //  <image class="checkmark" src="../assets/checkmark.png"/>${skill.skill3}
  //  <image class="checkmark" src="../assets/checkmark.png"/>${skill.skill4}
  //  ${
  //    skill.skill5 !== undefined
  //      ? `<image class="checkmark" src="../assets/checkmark.png"/>${skill.skill5}`
  //      : ""
  //  } `
}
